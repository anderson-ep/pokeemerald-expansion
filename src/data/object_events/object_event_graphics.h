...
const u32 gObjectEventPic_Calem[] = INCBIN_U32("graphics/object_events/pics/people/calem.4bpp");
const u16 gObjectEventPal_Calem[] = INCBIN_U16("graphics/object_events/pics/people/calem.gbapal");