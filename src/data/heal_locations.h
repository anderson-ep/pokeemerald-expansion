static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VANIVILLE_TOWN_1 - 1] = {MAP_GROUP(VANIVILLE_TOWN), MAP_NUM(VANIVILLE_TOWN), 29, 21},
    [HEAL_LOCATION_VANIVILLE_TOWN_2 - 1] = {MAP_GROUP(VANIVILLE_TOWN), MAP_NUM(VANIVILLE_TOWN), 17, 4},
    [HEAL_LOCATION_ROUTE1 - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    [HEAL_LOCATION_AQUACORDE_TOWN - 1] = {MAP_GROUP(AQUACORDE_TOWN), MAP_NUM(AQUACORDE_TOWN), 24, 12},
    [HEAL_LOCATION_SANTALUNE_CITY - 1] = {MAP_GROUP(SANTALUNE_CITY), MAP_NUM(SANTALUNE_CITY), 31, 22},
};
